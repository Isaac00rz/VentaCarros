$("#add").click(function () {
    ...
    tds += '<td style="width: 7.0%; min-width: 7.0%;"><input type="tel" name="telefono[]" maxlength="10" placeholder="No Semestre" required style="text-align: center; min-width: 100%; width:100%;"></td>'
