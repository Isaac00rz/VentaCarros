            ...
            @csrf
                    <table border="1" id="tab" style="display:inline-block;">
                        ...
                        <td class="tds"><input class="inputs" type="text" name="nombre" maxlength = "100" placeholder="Nombre" value="{{$vendedor->nombre}}" required></td>
                            <td class="tds"><input class="inputs" type="text" name="apellidoP" maxlength="100" placeholder="Apellido Paterno" value="{{$vendedor->apellidoP}}" required></td>
                            <td class="tds"><input class="inputs" type="text" name="apellidoM" maxlength="100" placeholder="Apellido Materno" value="{{$vendedor->apellidoM}}" required></td>
