            ...
            @csrf
                    <table border="1" id="tab" style="display:inline-block;">
                        ...
                        @foreach ($clientes as $cliente)
                            ...
                            <td class="tds"><input class="inputs" type="number" name="noExterior" maxlength="10" placeholder="No Exterior" value="{{$cliente->noExt}}" required></td>
                            <td class="tds"><input class="inputs" type="number" name="noInterior" maxlength="10" placeholder="No Interior" value="{{$cliente->noInt}}" required></td>
